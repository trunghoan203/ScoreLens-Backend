...
adminRouter.post('/forgotPassword', validate(forgotPasswordSchema), forgotPassword);
adminRouter.post('/verify-resetCode', validate(verifyResetCodeSchema), verifyResetCode);
adminRouter.post('/set-newPassword', validate(setNewPasswordSchema), setNewPassword);
adminRouter.post('/resend-verification', validate(resendVerificationCodeSchema), resendVerificationCode);
adminRouter.post('/resend-reset-password', validate(resendResetPasswordCodeSchema), resendResetPasswordCode);
